...
const monsters = [
  ...
  },
  {
    ...
    level: 8,
    health: 60,
    image:"images/fangedbeast.png"
  },
  {
    name: "RATHALOS",
    level: 20,
    health: 300,
    image:"images/rathalos.png"
  },
]
...
const locations = [
  ...
  },
  {
    ...
    text: "You entered a cave and see some monsters.",
  ...
  },
  {
    ...
    text: "You are fighting a monster now."
  },
  {
    name: "kill monster",
...
if (Math.random() <= .1) {
    ...
    text.innerText = "You can't use it anymore.";
    text.innerText = "You can only use sticks now.";
    currentWeapon = 0;
}
